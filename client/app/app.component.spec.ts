...
describe('Component: App', () => {
  ...
  it('should display the navigation bar correctly for guests', () => {
    ...
    expect(de[0].nativeElement.textContent).toContain('About');
    ...
    expect(de[4].nativeElement.textContent).toContain('Pairs');
    ...
    expect(de[4].attributes['routerLink']).toBe('/pairs');
  });
